        ...
        <div id="cadastro"> 
            ...
            <div id="cadastroInformacoes">
                ...
                <!-- As variaveis modo e id, foram utilizadas no action do form, 
                    ...
                    enctype="multipart/form-data" é obrigatório ser 
                        utilizado quando for trabalhar com imagens
                    Obs: (Para trabalhar com a input type="file") é 
                        obrigatório utilizar o metodo POST
                -->
